 ...
 * @author Ahmed
 */
public class Add_Place extends javax.swing.JFrame {
    PlaceController pc=new PlaceController();
    

    /**
     * Creates new form Add_Place
     */
    public Add_Place() {
        initComponents();
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(des, javax.swing.GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
                    .addComponent(Name)
                    .addComponent(lon)
                    .addComponent(lat))
                .addGap(55, 55, 55))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            pc.addNewPlace(Name.getText(),des.getText(),Integer.valueOf(lon.getText()),Integer.valueOf(lat.getText()));
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(Add_Place.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Place.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
